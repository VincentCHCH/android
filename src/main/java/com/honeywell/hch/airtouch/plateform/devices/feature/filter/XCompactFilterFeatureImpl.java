 ...
 */
public class XCompactFilterFeatureImpl implements IFilterFeature {
    ...
    public String[] getFilterPurchaseUrls() {
        return new String[]{AppConfig.shareInstance().getBasePurchaseUrl() +
                "version=2&model=550F-prefilter&product=KJ550F-PAC2156W&country=China", AppConfig.shareInstance().getBasePurchaseUrl() +
                "version=2&model=550F-polytechfilter&product=KJ550F-PAC2156W&country=China"};
    }
