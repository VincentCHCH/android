...
import com.honeywell.hch.airtouch.plateform.devices.feature.filter.AirTouch450UpdateFilterFeatureImpl;
import com.honeywell.hch.airtouch.plateform.devices.feature.filter.AirTouchSFilterFeatureImpl;
import com.honeywell.hch.airtouch.plateform.devices.feature.filter.AirTouchSUpdateFilterFeatureImpl;
...
import com.honeywell.hch.airtouch.plateform.devices.feature.filter.X3UpdateCompactFilterFeatureImpl;
import com.honeywell.hch.airtouch.plateform.devices.feature.filter.XCompactFilterFeatureImpl;
    ...
    private void addFilterFeature(int deviceType) {
        switch (deviceType) {
            ...
            case HPlusConstants.AIRTOUCH_FFAC_TYPE:
                ...
                break;
            case HPlusConstants.AIRTOUCH_XCOMPACT_TYPE:
                iFilterFeature = new XCompactFilterFeatureImpl();
                break;
            case HPlusConstants.AIRTOUCH_X3COMPACT_TYPE:
                iFilterFeature = new X3CompactFilterFeatureImpl();
                break;
            case HPlusConstants.AIRTOUCH_X3COMPACT_UPDATE_TYPE:
                iFilterFeature = new X3UpdateCompactFilterFeatureImpl();
                break;
            case HPlusConstants.AIRTOUCH_S_UPDATE_TYPE:
                iFilterFeature = new AirTouchSUpdateFilterFeatureImpl();
                break;
            case HPlusConstants.AIRTOUCH_450_UPDATE_TYPE:
                iFilterFeature = new AirTouch450UpdateFilterFeatureImpl();
                break;
        }
    }
