...
public class Water50SFilterFeatureImpl implements IFilterFeature {
    ...
    public String[] getFilterPurchaseUrls() {
        return new String[]{AppConfig.shareInstance().getBasePurchaseUrl() +
                "model=RO50G-CompositeCartridge&product=YCZ-CT8-HRO-001&country=China&version=2",
                AppConfig.shareInstance().getBasePurchaseUrl() + "model=RO50G-ROCartridge&product=YCZ-CT8-HRO-001&country=China&version=2",
                AppConfig.shareInstance().getBasePurchaseUrl() + "model=RO50G-ActiveCarbonCartridge&product=YCZ-CT8-HRO-001&country=China&version=2"};
    }
